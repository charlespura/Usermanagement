...
<div class="sidebar-header" style="display: flex; align-items: center; gap: 10px;  margin-top: 80px; margin-bottom: 30px;">
  ...
  <li><a href="user_dashboard.php"><span>🏠</span> Dashboard</a></li>
<li><a href="view_user.php"><span>📝</span> View My Information  </a></li>
<li><a href="edit_user.php"><span>📄</span> Edit My Information</a></li>
